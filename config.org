...
Desktop notifications for org-pomodoro using the alert package. Uses D-Bus
notifications which integrate with KDE Plasma and other desktop environments.
...
#+begin_src emacs-lisp
(after! alert
  (setq alert-default-style 'notifications))  ; uses D-Bus, works with Plasma

(after! org-pomodoro
  (setq org-pomodoro-keep-killed-pomodoro-time t)

  ;; Hook alerts into pomodoro events
  (add-hook 'org-pomodoro-finished-hook
            (lambda () (alert "Pomodoro finished!" :title "org-pomodoro")))
  (add-hook 'org-pomodoro-break-finished-hook
            (lambda () (alert "Break over!" :title "org-pomodoro")))
  (add-hook 'org-pomodoro-killed-hook
            (lambda () (alert "Pomodoro killed" :title "org-pomodoro")))
